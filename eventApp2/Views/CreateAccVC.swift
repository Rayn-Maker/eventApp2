...
class CreateAccVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if doesHaveAcct {
            ...
            self.profilePic.image = UIImage(data: user.profilePicData!)
        } 
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) { // UIImagePickerControllerEditedImage
        if let image = info[UIImagePickerController.InfoKey.editedImage] as? UIImage {
            ...
            self.user.profilePicData = image.jpegData(compressionQuality: 0.5)
        }
        self.dismiss(animated: true, completion: nil)
    }
    ...
    func saveImage() {
        ...
        let data = self.user.profilePicData
        UserDefaults.standard.set(self.user.profilePicData, forKey: "pictureData")
